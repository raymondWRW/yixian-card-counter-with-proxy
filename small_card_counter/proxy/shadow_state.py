...
# 11000003 etc.) before being stored in any ZoneCard.
_DIVINER_EVEN_FACES: set = {
    11000004, 11010004, 11020004, 11030004, 11040004,  # 天谕·攻
    11000008, 11010008, 11020008, 11030008, 11040008,  # 天运·趋吉
    11000012, 11010012, 11020012, 11030012, 11040012,  # 天命·重现
    11000020, 11010020, 11020020, 11030020, 11040020,  # 天机·逆施
    11000026, 11010026, 11020026, 11030026, 11040026,  # 天星·御心
}


def canonical_card_id(card_id: int) -> int:
    """For paired Diviner transform cards, return the canonical (lower-id)
    face. Non-paired cards return unchanged."""
